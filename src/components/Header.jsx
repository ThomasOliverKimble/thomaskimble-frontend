...
function Header() {
  return (
    <>
      <header id='header' className='fixed z-20 h-[5rem] md:h-[6rem] w-full visible opacity-100 2xl:invisible 2xl:opacity-0 transition duration-200 ease-in-out'>
        ...
        <div id='header-text' className='relative m-auto h-fit w-60 py-6 md:py-8 invisible opacity-0 sm:visible sm:opacity-100 lg:invisible lg:opacity-0 [&.not-scroll]:invisible [&.not-scroll]:opacity-0 transition duration-200 ease-in-out not-scroll'>
          <img id='header-text-logo' src='/media/text/blue/text_thomaskimble.svg' alt='thomaskimble-creme' className='relative'/>
        </div>
        <nav className='flex invisible opacity-0 lg:visible lg:opacity-100 2xl:invisible 2xl:opacity-0 absolute right-0 top-0 h-full items-center pr-10 text-2xl font-extrabold transition duration-200 ease-in-out'>
