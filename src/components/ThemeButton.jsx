  ...
  return (
    <>
      <button
        ...
        onClick={toggleTheme}
        disabled={swipe}
        className={`fixed right-4 z-20 top-[calc(100svh-3rem)] md:top-[calc(100svh-4rem)] md:right-6 lg:top-8 lg:right-7 font-bold py-1 px-2 md:py-1.5 md:px-3 rounded shadow bg-primary hover:bg-primary_highlight text-fond`}
      >
