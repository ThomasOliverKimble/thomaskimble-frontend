...
function Header() {
  ...
  return (
    <header
      id="header"
      className="fixed z-10 h-[6rem] transform -translate-y-4 w-full transition-opacity duration-500 ease-in-out md:translate-y-0 2xl:-translate-y-full 2xl:invisible 2xl:opacity-0"
    >
      ...
      <div
        id="header-text"
        className="relative m-auto h-fit w-60 transform transition-opacity duration-500 ease-in-out translate-y-7 opacity-0 invisible [&.scroll]:md:opacity-100 [&.scroll]:md:visible [&.scroll]:lg:invisible [&.scroll]:lg:opacity-0"
        >
        <img
          id="header-text-logo"
